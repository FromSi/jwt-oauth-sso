...
//
//	mockgen -destination=../../mocks/services/mock_mutable_notification.go -package=services_mocks github.com/fromsi/jwt-oauth-sso/internal/services MutableNotificationService
//
