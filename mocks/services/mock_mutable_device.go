...
//
//	mockgen -destination=../../mocks/services/mock_mutable_device.go -package=services_mocks github.com/fromsi/jwt-oauth-sso/internal/services MutableDeviceService
//
