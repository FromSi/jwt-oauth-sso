...
//
//	mockgen -destination=../../mocks/services/mock_query_reset_token.go -package=services_mocks github.com/fromsi/jwt-oauth-sso/internal/services QueryResetTokenService
//
