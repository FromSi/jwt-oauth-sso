...
func Test_NewBaseRegisterRequest_And_NewBaseRegisterRequestBody_And_GetBody(t *testing.T) {
	requestBody := NewBaseRegisterRequestBody()

	assert.NotNil(t, requestBody)

	request := NewBaseRegisterRequest(requestBody)

	assert.NotNil(t, request)
	assert.Equal(t, requestBody, request.GetBody())
}

func TestNewBaseRegisterRequestBody_GetEmail(t *testing.T) {
	requestBody := NewBaseRegisterRequestBody()
...
func TestNewBaseRegisterRequestBody_GetPassword(t *testing.T) {
	requestBody := NewBaseRegisterRequestBody()
...
func TestNewBaseRegisterRequest_GetIP(t *testing.T) {
	requestBody := NewBaseRegisterRequestBody()
...
func TestNewBaseRegisterRequest_GetUserAgent(t *testing.T) {
	requestBody := NewBaseRegisterRequestBody()
...
func TestNewBaseRegisterRequest_Make(t *testing.T) {
	requestConstructorBody := NewBaseRegisterRequestBody()

	assert.NotNil(t, requestConstructorBody)

	requestConstructor := NewBaseRegisterRequest(requestConstructorBody)
