...
func Test_NewBaseSuccessLoginResponse(t *testing.T) {
	response := NewBaseSuccessLoginResponse()

	assert.NotNil(t, response)
}

func TestNewBaseSuccessLoginResponse_Make(t *testing.T) {
	responseConstructor := NewBaseSuccessLoginResponse()
