...
func Test_NewBaseSuccessRefreshResponse(t *testing.T) {
	response := NewBaseSuccessRefreshResponse()

	assert.NotNil(t, response)
}

func TestNewBaseSuccessRefreshResponse_Make(t *testing.T) {
	responseConstructor := NewBaseSuccessRefreshResponse()
